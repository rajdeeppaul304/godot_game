...
func next_scene():
	request_scene_change.emit("last_level_part_7", "spawnpoint1", false)  # Or whatever scene you want
	
func previous_scene():
	request_scene_change.emit("last_level_part_2", "spawnpoint2", false)  # Or whatever scene you want
